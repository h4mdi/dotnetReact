      ...
      {!isLoading && (
        <form onSubmit={handleSubmit(onSubmit)}>
          <FormControl mb={2} isInvalid={errors.departmentId} isRequired>
            <FormLabel htmlFor='departmentId'>Département</FormLabel>
            <Select
              id='departmentId'
              {...register('departmentId', {
                validate: value => value > 0 || 'Department est obligatoire',
                valueAsNumber: true,
              })}
              onChange={e =>
          ...
          <HStack mt={5}>
            ...
            <Button
              ...
              type={'submit'}
            >
              {formType === 'update' ? 'Mettre à jour' : 'Ajouter'}
            </Button>
          </HStack>
        </form>
      )}
